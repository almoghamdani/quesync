...
g++ client\socket-manager.cpp client\voice-chat.cpp client\client.cpp -I include -L lib -lbass -lopus -lOpenAL32 -lws2_32 -static-libgcc -static-libstdc++ -o build\client.exe
